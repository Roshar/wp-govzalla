...
//                            the_custom_logo();
                            ...
                            <div class="site-branding__logo-box">
                                ...
                                <h1 class="site-title font-family-1">
                                    <a href="<?php echo esc_url(home_url('/')); ?>" rel="home"><span class="first_peace_title">Государственное бюджетное учреждение  дополнительного профессионального образования <br/></span>  <span class ="second_peace_title">«Институт развития образования <br/> Чеченской Республики»</span> </a>
                                </h1>
                            </div>
